...
{
	if( EQUSTR(pstrName, _T("ScrollBar")) ) 
...
void CScrollBarUI::DoEvent(TEventUI& event)
{
	...
	if( event.Type == UIEVENT_MOUSEMOVE )
	{
		if( (m_uThumbState & UISTATE_CAPTURED) != 0 ) {
			if( !m_bHorizontal ) {
				int v = m_rcItem.bottom - m_rcItem.top - m_rcThumb.bottom + m_rcThumb.top - 2 * m_cxyFixed.cx;
				if( v == 0 )
					m_nLastScrollOffset = 0;
				else
					m_nLastScrollOffset = (event.ptMouse.y - ptLastMouse.y) * m_nRange / v;
					//(m_rcItem.bottom - m_rcItem.top - m_rcThumb.bottom + m_rcThumb.top - 2 * m_cxyFixed.cx);
			}
			else {
				int v = (m_rcItem.right - m_rcItem.left - m_rcThumb.right + m_rcThumb.left - 2 * m_cxyFixed.cy);
				if( v == 0 )
					m_nLastScrollOffset = 0;
				else
					m_nLastScrollOffset = (event.ptMouse.x - ptLastMouse.x) * m_nRange / v;
...
{
	if( EQUSTR(pstrName, _T("button1normalimage")) ) 
		SetButton1NormalImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button1hotimage")) ) 
		SetButton1HotImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button1pushedimage")) ) 
		SetButton1PushedImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button1disabledimage")) ) 
		SetButton1DisabledImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button2normalimage")) ) 
		SetButton2NormalImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button2hotimage")) ) 
		SetButton2HotImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button2pushedimage")) ) 
		SetButton2PushedImage(pstrValue);
	else if( EQUSTR(pstrName, _T("button2disabledimage")) ) 
		SetButton2DisabledImage(pstrValue);
	else if( EQUSTR(pstrName, _T("thumbnormalimage")) ) 
		SetThumbNormalImage(pstrValue);
	else if( EQUSTR(pstrName, _T("thumbhotimage")) ) 
		SetThumbHotImage(pstrValue);
	else if( EQUSTR(pstrName, _T("thumbpushedimage")) ) 
		SetThumbPushedImage(pstrValue);
	else if( EQUSTR(pstrName, _T("thumbdisabledimage")) ) 
		SetThumbDisabledImage(pstrValue);
	else if( EQUSTR(pstrName, _T("railnormalimage")) ) 
		SetRailNormalImage(pstrValue);
	else if( EQUSTR(pstrName, _T("railhotimage")) ) 
		SetRailHotImage(pstrValue);
	else if( EQUSTR(pstrName, _T("railpushedimage")) ) 
		SetRailPushedImage(pstrValue);
	else if( EQUSTR(pstrName, _T("raildisabledimage")) ) 
		SetRailDisabledImage(pstrValue);
	else if( EQUSTR(pstrName, _T("bknormalimage")) ) 
		SetBkNormalImage(pstrValue);
	else if( EQUSTR(pstrName, _T("bkhotimage")) ) 
		SetBkHotImage(pstrValue);
	else if( EQUSTR(pstrName, _T("bkpushedimage")) ) 
		SetBkPushedImage(pstrValue);
	else if( EQUSTR(pstrName, _T("bkdisabledimage")) ) 
		SetBkDisabledImage(pstrValue);
	else if( EQUSTR(pstrName, _T("hor")) ) 
		SetHorizontal( EQUSTR(pstrValue, _T("true")) );
	else if( EQUSTR(pstrName, _T("linesize")) ) 
		SetLineSize(_ttoi(pstrValue));
	else if( EQUSTR(pstrName, _T("range")) ) 
		SetScrollRange(_ttoi(pstrValue));
	else if( EQUSTR(pstrName, _T("value")) ) 
		SetScrollPos(_ttoi(pstrValue));
	else if( EQUSTR(pstrName, _T("showbutton1")) ) 
		SetShowButton1( EQUSTR(pstrValue, _T("true")) );
	else if( EQUSTR(pstrName, _T("showbutton2")) ) 
		SetShowButton2( EQUSTR(pstrValue, _T("true")) );
