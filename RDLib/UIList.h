...
typedef struct tagTListInfoUI
{
    ...
    CStringW sSelectedImage;
    DWORD dwHotTextColor;
    DWORD dwHotBkColor;
    CStringW sHotImage;
    DWORD dwDisabledTextColor;
    DWORD dwDisabledBkColor;
    CStringW sDisabledImage;
    DWORD dwLineColor;
    bool bShowHtml;
...
class RDLIB_API CListUI : public CVerticalLayoutUI, public IListUI
{
public:
    CListUI();
...
class RDLIB_API CListBodyUI : public CVerticalLayoutUI
{
public:
...
class RDLIB_API CListHeaderUI : public CHorizontalLayoutUI
{
public:
    CListHeaderUI();
...
class RDLIB_API CListHeaderItemUI : public CControlUI
{
public:
    CListHeaderItemUI();
...
protected:
    ...
    CStringW m_sSepImage;
    CStringW m_sSepImageModify;
};
...
class RDLIB_API CListElementUI : public CControlUI, public IListItemUI
{
public:
    CListElementUI();
...
class RDLIB_API CListLabelElementUI : public CListElementUI
{
public:
    CListLabelElementUI();
	CListLabelElementUI(LPCWSTR text, LPCWSTR userData);
    LPCTSTR GetClass() const;
    LPVOID GetInterface(LPCTSTR pstrName);
...
class RDLIB_API CListTextElementUI : public CListLabelElementUI
{
public:
    CListTextElementUI();
    ~CListTextElementUI();
...
class RDLIB_API CListContainerElementUI : public CContainerUI, public IListItemUI
{
public:
...
class RDLIB_API CListHeaderShadowUI : public CControlUI
{
public:
	LPCTSTR GetClass() const;
	SIZE EstimateSize(SIZE szAvailable);
...
class RDLIB_API CSeparatorLineUI : public CControlUI
{
public:
	LPCTSTR GetClass() const;
	SIZE EstimateSize(SIZE szAvailable);
