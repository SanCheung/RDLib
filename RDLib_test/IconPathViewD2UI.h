...
class CIconPathViewD2UI	: public CHostableWnd
						, public CAniJob
						//, public CGestureBase
						, public IDrawer
{
public:
	CIconPathViewD2UI(void);
	virtual ~CIconPathViewD2UI(void);

	virtual UINT GetClassStyle() const			{ return UI_CLASSSTYLE_CHILD; }
	virtual LPCTSTR GetWindowClassName() const	{ return L"ui_iconPathWithD2d_classname"; }
...
public:
	static	CIconPathViewD2UI* CreateUI( HWND hWnd );
};